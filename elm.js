...
var author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3(author$project$Main$Model, key, url, author$project$Main$HomePage),
			A2(
...
var author$project$Main$FundsPage = {$: 'FundsPage'};
var author$project$Main$UsersPage = {$: 'UsersPage'};
var author$project$Main$Fund = function (a) {
	return {$: 'Fund', a: a};
};
...
var author$project$Main$routeParser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			author$project$Main$Fund,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('/fund/'),
...
var author$project$Main$updateUrl = F2(
	function (url, model) {
		var _n0 = A2(elm$url$Url$Parser$parse, author$project$Main$routeParser, url);
		if (_n0.$ === 'Just') {
			if (_n0.a.$ === 'Fund') {
				return _Utils_Tuple2(
					{key: model.key, page: author$project$Main$FundsPage, url: url},
					elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(
					{key: model.key, page: author$project$Main$UsersPage, url: url},
					elm$core$Platform$Cmd$none);
			}
		} else {
			var _n1 = url.path;
			switch (_n1) {
				...
				default:
					return _Utils_Tuple2(
						{key: model.key, page: author$project$Main$HomePage, url: url},
						elm$core$Platform$Cmd$none);
			}
		}
	});
	...
	var links = A2(
		...
		_List_fromArray(
			[
				A2(
				navLink,
				author$project$Main$FundsPage,
				{caption: 'Funds', url: '/funds'}),
				A2(
				navLink,
				author$project$Main$UsersPage,
				{caption: 'Users', url: '/users'})
			]));
	return A2(
		elm$html$Html$nav,
		_List_fromArray(
	...
	switch (_n0.$) {
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$href('https://cdnjs.cloudflare.com/ajax/libs/bulma/0.7.5/css/bulma.css')
							]),
						_List_Nil),
						author$project$Main$viewHeader(author$project$Main$FundsPage),
						elm$html$Html$text(
		...
		default:
			return {
				body: _List_fromArray(
					[
						author$project$Main$viewHeader(author$project$Main$UsersPage),
						elm$html$Html$text(model.url.path)
					]),
				title: 'Users'
			};
